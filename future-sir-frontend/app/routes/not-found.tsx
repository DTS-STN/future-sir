...
export default function NotFound(componentProps: Route.ComponentProps) {
  const { currentLanguage } = useLanguage();

  // prettier-ignore
  return currentLanguage
    ? <UnilingualNotFound {...componentProps} />
    : <BilingualNotFound {...componentProps} />;
}

function BilingualNotFound(componentProps: Route.ComponentProps) {
...
function UnilingualNotFound(componentProps: Route.ComponentProps) {
