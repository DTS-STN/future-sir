...
export default function App(componentProps: Route.ComponentProps) {
...
export function ErrorBoundary(errorBoundaryProps: Route.ErrorBoundaryProps) {
  const { currentLanguage } = useLanguage();

  // prettier-ignore
  return currentLanguage
    ? <UnilingualErrorBoundary {...errorBoundaryProps} />
    : <BilingualErrorBoundary {...errorBoundaryProps} />;
}

function BilingualErrorBoundary(errorBoundaryProps: Route.ErrorBoundaryProps) {
...
export function UnilingualErrorBoundary(errorBoundaryProps: Route.ErrorBoundaryProps) {
  const { currentLanguage } = useLanguage();
