...
import type { ServerEnvironment } from '~/.server/express-server/environment.server';
...
export class AzureAuthenticationStrategy extends BaseAuthenticationStrategy {
  constructor(environment: ServerEnvironment, origin: URL) {
    super(
      new URL(environment.AZURE_ISSUER_URL),
      new URL('/auth/callback/azure', origin),
