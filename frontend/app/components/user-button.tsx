...
export function UserButton({ className, children, name }: UserButtonProps) {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        className={cn(
          'focus:outline-hidden flex h-full flex-nowrap space-x-2 bg-slate-600 px-2 text-sm text-white hover:bg-slate-500 hover:underline focus:ring-2 focus:ring-black focus:ring-offset-2 aria-expanded:bg-slate-800 aria-expanded:text-white sm:space-x-4 sm:px-4',
          className,
        )}
      >
